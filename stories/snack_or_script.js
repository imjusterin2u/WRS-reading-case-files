...
const ROUNDS_SNACK_OR_SCRIPT = [
  ...
  { id:'spelling', tab:'Spelling', title:"Case File 4 — Spelling Forensics", icon:'✏️',
    ...
    questions:[
      {word:'campus', sentence:'Dennis went to meet Meg on campus.', morphemes:[{text:'cam',type:'base'}, {text:'pus',type:'base'}]},
      {word:'candid', sentence:'Meg was candid with Dennis.', morphemes:[{text:'can',type:'base'}, {text:'did',type:'base'}]},
      {word:'submit', sentence:'She had to submit the text in class.', morphemes:[{text:'sub',type:'base'}, {text:'mit',type:'base'}]},
      {word:'publish', sentence:'She had things left to publish the script.', morphemes:[{text:'pub',type:'base'}, {text:'lish',type:'base'}]},
      {word:'panic', sentence:'Dennis did not want to witness her panic.', morphemes:[{text:'pan',type:'base'}, {text:'ic',type:'base'}]},
      {word:'index', sentence:'Dennis would set up an index.', morphemes:[{text:'in',type:'base'}, {text:'dex',type:'base'}]},
      {word:'laptop', sentence:'They saved everything on her laptop.', morphemes:[{text:'lap',type:'base'}, {text:'top',type:'base'}]},
      {word:'fret', sentence:'Dennis told Meg not to fret.'},
      {word:'lemon', sentence:'Meg had some lemon drops for them.', morphemes:[{text:'lem',type:'base'}, {text:'on',type:'base'}]},
      {word:'hummus', sentence:'He asked Meg to get some hummus.', morphemes:[{text:'hum',type:'base'}, {text:'mus',type:'base'}]},
    ]},
