...
const ROUNDS_THE_ATLANTIC = [
  ...
  { id:'spelling', tab:'Spelling', title:"Case File 4 — Spelling Forensics", icon:'✏️',
    ...
    questions:[
      {word:'Atlantic', sentence:'The Atlantic is so big and vast.', morphemes:[{text:'At',type:'base'}, {text:'lan',type:'base'}, {text:'tic',type:'base'}]},
      {word:'subtropics', sentence:'Some of the Atlantic is in the subtropics.', morphemes:[{text:'sub',type:'prefix'}, {text:'trop',type:'base'}, {text:'ics',type:'base'}]},
      {word:'vanish', sentence:'The fish are at risk and may vanish.', morphemes:[{text:'van',type:'base'}, {text:'ish',type:'base'}]},
      {word:'overfish', sentence:'People need to be strict and not overfish.', morphemes:[{text:'o',type:'base'}, {text:'ver',type:'base'}, {text:'fish',type:'base'}]},
      {word:'mammals', sentence:'Some Atlantic mammals get very sick.', morphemes:[{text:'mam',type:'base'}, {text:'mal',type:'base'}, {text:'s',type:'suffix'}]},
      {word:'imprison', sentence:'These nets can imprison the mammals.', morphemes:[{text:'im',type:'prefix'}, {text:'pris',type:'base'}, {text:'on',type:'base'}]},
      {word:'fantastic', sentence:'Let\'s help the fantastic Atlantic today.', morphemes:[{text:'fan',type:'base'}, {text:'tas',type:'base'}, {text:'tic',type:'base'}]},
      {word:'rubbish', sentence:'Mammals get sick from all this rubbish.', morphemes:[{text:'rub',type:'base'}, {text:'bish',type:'base'}]},
      {word:'remove', sentence:'We can all help to remove the junk.', morphemes:[{text:'re',type:'base'}, {text:'move',type:'base'}]},
