...
const ROUNDS_MOVE_TO_STATES = [
  ...
  { id:'spelling', tab:'Spelling', title:"Case File 4 — Spelling Forensics", icon:'✏️',
    ...
    questions:[
      {word:'prepare', sentence:'Bruno and Irene wake up before sunrise to prepare.', morphemes:[{text:'pre',type:'prefix'}, {text:'pare',type:'base'}]},
      {word:'polite', sentence:'Bruno is polite and always gives a wide smile.', morphemes:[{text:'po',type:'base'}, {text:'lite',type:'base'}]},
      {word:'relax', sentence:'Bruno sits on the front deck to relax.', morphemes:[{text:'re',type:'prefix'}, {text:'lax',type:'base'}]},
      {word:'music', sentence:'Bruno plays music from the Azores.', morphemes:[{text:'mu',type:'base'}, {text:'sic',type:'base'}]},
      {word:'pecan', sentence:'They make pecan donuts before the sun is up.', morphemes:[{text:'pe',type:'base'}, {text:'can',type:'base'}]},
      {word:'jumbo', sentence:'They begin to make jumbo bagels.', morphemes:[{text:'jum',type:'base'}, {text:'bo',type:'base'}]},
      {word:'menu', sentence:'Bruno sets a menu on top of a stand.', morphemes:[{text:'me',type:'base'}, {text:'nu',type:'base'}]},
      {word:'public', sentence:'Bruno lets the public into the bake shop.', morphemes:[{text:'pub',type:'base'}, {text:'lic',type:'base'}]},
      {word:'landscape', sentence:'They learned to bake on the volcanic landscape of the Azores.', morphemes:[{text:'land',type:'base'}, {text:'scape',type:'base'}]},
      {word:'customs', sentence:'He can share the old customs from the Azores.', morphemes:[{text:'cus',type:'base'}, {text:'tom',type:'base'}, {text:'s',type:'suffix'}]},
    ]},
