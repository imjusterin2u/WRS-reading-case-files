...
const ROUNDS_SPRING_JOB = [
  ...
  { id:'spelling', tab:'Spelling', title:"Case File 4 — Spelling Forensics", icon:'✏️',
    ...
    questions:[
      ...
      {word:'frost', sentence:'When all the cold and frost ends.', excludeWeld:['ost']},
  ...
  { id:'structure', tab:'Structure', title:"Case File 5 — Structure Analysis", icon:'🧩',
    ...
    questions:[
      ...
      {context:'frost', prompt:'Which letters form the beginning consonant blend?', options:['fr','ro','ost','st'], answer:0,
        explain:'/f/ and /r/ blend together at the start of frost. Frost has a short o sound (like "lost"), so "ost" here is NOT the long-vowel exception chunk you would hear in "most" or "host."'},
