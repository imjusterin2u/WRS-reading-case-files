...
const ROUNDS_BEST_LUNCH = [
  ...
  { id:'spelling', tab:'Spelling', title:"Case File 4 — Spelling Forensics", icon:'✏️',
    ...
    questions:[
      {word:'number', sentence:'She has to check each number.', morphemes:[{text:'num',type:'base'}, {text:'ber',type:'base'}]},
      {word:'napkins', sentence:'I will put out some napkins and glasses.', morphemes:[{text:'nap',type:'base'}, {text:'kin',type:'base'}, {text:'s',type:'suffix'}]},
      {word:'muffins', sentence:'I can get the basket for the plum muffins.', morphemes:[{text:'muf',type:'base'}, {text:'fin',type:'base'}, {text:'s',type:'suffix'}]},
      {word:'shellfish', sentence:'I will grab the can of shellfish from the shelf.', morphemes:[{text:'shell',type:'base'}, {text:'fish',type:'base'}]},
      {word:'chitchat', sentence:'Ellen and her dad chitchat as they fix lunch.', morphemes:[{text:'chit',type:'base'}, {text:'chat',type:'base'}]},
      {word:'basket', sentence:'Ellen gets the basket for the muffins.', morphemes:[{text:'bas',type:'base'}, {text:'ket',type:'base'}]},
      {word:'happen', sentence:'We cannot let that happen.', morphemes:[{text:'hap',type:'base'}, {text:'pen',type:'base'}]},
      {word:'cannot', sentence:'Mom cannot miss lunch.', morphemes:[{text:'can',type:'base'}, {text:'not',type:'base'}]},
      {word:'plum', sentence:'Ellen gets the basket for the plum muffins.'},
      {word:'shrimp', sentence:'They will have shrimp salad.'},
      {word:'salad', sentence:'Dad will mix the shrimp into a salad.', morphemes:[{text:'sal',type:'base'}, {text:'ad',type:'base'}]},
