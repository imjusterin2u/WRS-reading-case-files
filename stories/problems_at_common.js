...
const ROUNDS_PROBLEMS_COMMON = [
  ...
  { id:'spelling', tab:'Spelling', title:"Case File 4 — Spelling Forensics", icon:'✏️',
    ...
    questions:[
      {word:'instant', sentence:'He would come check out the mess in an instant.', morphemes:[{text:'in',type:'base'}, {text:'stant',type:'base'}]},
      {word:'complex', sentence:'It was a complex job.', morphemes:[{text:'com',type:'base'}, {text:'plex',type:'base'}]},
      {word:'sandlot', sentence:'The sandlot was full of trash.', morphemes:[{text:'sand',type:'base'}, {text:'lot',type:'base'}]},
      {word:'lampposts', sentence:'Two lampposts were under some branches.', morphemes:[{text:'lamp',type:'base'}, {text:'post',type:'base'}, {text:'s',type:'suffix'}]},
      {word:'enlist', sentence:'Mr. Griffin would have to enlist help.', morphemes:[{text:'en',type:'base'}, {text:'list',type:'base'}]},
      {word:'profit', sentence:'He must make a small profit.', morphemes:[{text:'prof',type:'base'}, {text:'it',type:'base'}]},
      {word:'contrast', sentence:'The town boss saw the contrast.', morphemes:[{text:'con',type:'base'}, {text:'trast',type:'base'}]},
      {word:'impress', sentence:'Mr. Griffin, you impress me!', morphemes:[{text:'im',type:'prefix'}, {text:'press',type:'base'}]},
      {word:'install', sentence:'They had to install new posts.', morphemes:[{text:'in',type:'prefix'}, {text:'stall',type:'base'}]},
      {word:'submit', sentence:'He must get a bid to submit.', morphemes:[{text:'sub',type:'base'}, {text:'mit',type:'base'}]},
    ]},
