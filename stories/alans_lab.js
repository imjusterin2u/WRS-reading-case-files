...
const ROUNDS_ALANS_LAB = [
  ...
  { id:'spelling', tab:'Spelling', title:"Case File 4 — Spelling Forensics", icon:'✏️',
    ...
    questions:[
      {word:'inspects', sentence:'The staff inspects the water.', morphemes:[{text:'in',type:'prefix'}, {text:'spect',type:'base'}, {text:'s',type:'suffix'}]},
      {word:'conducts', sentence:'Alan conducts this test over and over.', morphemes:[{text:'con',type:'prefix'}, {text:'duct',type:'base'}, {text:'s',type:'suffix'}]},
      {word:'toxins', sentence:'The staff checks for toxins.', morphemes:[{text:'tox',type:'base'}, {text:'in',type:'base'}, {text:'s',type:'suffix'}]},
      {word:'methods', sentence:'The lab insists on the best methods.', morphemes:[{text:'meth',type:'base'}, {text:'od',type:'base'}, {text:'s',type:'suffix'}]},
      {word:'complex', sentence:'The methods are complex.', morphemes:[{text:'com',type:'base'}, {text:'plex',type:'base'}]},
      {word:'solvent', sentence:'He injects the water with a solvent.', morphemes:[{text:'sol',type:'base'}, {text:'vent',type:'base'}]},
      {word:'attest', sentence:'He can attest that the numbers are exact.', morphemes:[{text:'at',type:'base'}, {text:'test',type:'base'}]},
      {word:'exact', sentence:'The numbers are exact.', morphemes:[{text:'ex',type:'base'}, {text:'act',type:'base'}]},
      {word:'impact', sentence:'The water tests make a big impact.', morphemes:[{text:'im',type:'base'}, {text:'pact',type:'base'}]},
      {word:'collects', sentence:'Alan collects gallons of water.', morphemes:[{text:'col',type:'base'}, {text:'lect',type:'base'}, {text:'s',type:'suffix'}]},
    ]},
