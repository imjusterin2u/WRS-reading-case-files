...
const ROUNDS_WALKING_TALKING = [
  ...
  { id:'spelling', tab:'Spelling', title:"Case File 4 — Spelling Forensics", icon:'✏️',
    ...
    questions:[
      {word:'walking', sentence:'They insist on walking every day.', morphemes:[{text:'walk',type:'base'}, {text:'ing',type:'suffix'}]},
      {word:'talking', sentence:'They both want to walk and talk.', morphemes:[{text:'talk',type:'base'}, {text:'ing',type:'suffix'}]},
      {word:'hunting', sentence:'He wants to spend each day hunting for frogs.', morphemes:[{text:'hunt',type:'base'}, {text:'ing',type:'suffix'}]},
      {word:'golfing', sentence:'He wants to spend each day golfing with his dad.', morphemes:[{text:'golf',type:'base'}, {text:'ing',type:'suffix'}]},
      {word:'attending', sentence:'She plans on attending an acting class.', morphemes:[{text:'at',type:'base'}, {text:'tend',type:'base'}, {text:'ing',type:'suffix'}]},
      {word:'called', sentence:'Her mom called last month.', morphemes:[{text:'call',type:'base'}, {text:'ed',type:'suffix'}]},
      {word:'landed', sentence:'They have landed at the front of the school.', morphemes:[{text:'land',type:'base'}, {text:'ed',type:'suffix'}]},
      {word:'talented', sentence:'Jazmin could be a talented actress.', morphemes:[{text:'tal',type:'base'}, {text:'ent',type:'base'}, {text:'ed',type:'suffix'}]},
      {word:'insist', sentence:'They insist on walking every day.', morphemes:[{text:'in',type:'base'}, {text:'sist',type:'base'}]},
      {word:'subject', sentence:'Angus jumps right into this subject.', morphemes:[{text:'sub',type:'base'}, {text:'ject',type:'base'}]},
    ]},
