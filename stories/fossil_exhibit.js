...
const ROUNDS_FOSSIL_EXHIBIT = [
  ...
  { id:'spelling', tab:'Spelling', title:"Case File 4 — Spelling Forensics", icon:'✏️',
    ...
    questions:[
      {word:'splendid', sentence:'Ingrid has a splendid plan for the day.', morphemes:[{text:'splen',type:'base'}, {text:'did',type:'base'}]},
      {word:'ecstatic', sentence:'She is ecstatic about the exhibit.', morphemes:[{text:'ec',type:'base'}, {text:'stat',type:'base'}, {text:'ic',type:'base'}]},
      {word:'exhibit', sentence:'She is on her way to the fossil exhibit.', morphemes:[{text:'ex',type:'base'}, {text:'hib',type:'base'}, {text:'it',type:'base'}]},
      {word:'admonish', sentence:'Her boss did not admonish her.', morphemes:[{text:'ad',type:'base'}, {text:'mon',type:'base'}, {text:'ish',type:'base'}]},
      {word:'indignant', sentence:'She is not upset or indignant at all.', morphemes:[{text:'in',type:'base'}, {text:'dig',type:'base'}, {text:'nant',type:'base'}]},
      {word:'exotic', sentence:'She can touch the exotic rocks and shells.', morphemes:[{text:'ex',type:'base'}, {text:'ot',type:'base'}, {text:'ic',type:'base'}]},
      {word:'fantastic', sentence:'It is fantastic!', morphemes:[{text:'fan',type:'base'}, {text:'tas',type:'base'}, {text:'tic',type:'base'}]},
      {word:'snapdragons', sentence:'There are snapdragons everywhere.', morphemes:[{text:'snap',type:'base'}, {text:'drag',type:'base'}, {text:'on',type:'base'}, {text:'s',type:'suffix'}]},
      {word:'recommend', sentence:'She is quick to recommend the exhibit.', morphemes:[{text:'re',type:'base'}, {text:'com',type:'base'}, {text:'mend',type:'base'}]},
      {word:'congressman', sentence:'Her boss, the congressman, was glad to help.', morphemes:[{text:'con',type:'base'}, {text:'gress',type:'base'}, {text:'man',type:'base'}]},
    ]},
