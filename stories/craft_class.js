...
const ROUNDS_CRAFT_CLASS = [
  ...
  { id:'spelling', tab:'Spelling', title:"Case File 4 — Spelling Forensics", icon:'✏️',
    ...
    questions:[
      {word:'instructs', sentence:'Mrs. Waters instructs a craft class.', morphemes:[{text:'in',type:'prefix'}, {text:'struct',type:'base'}, {text:'s',type:'suffix'}]},
      {word:'construct', sentence:'They wish to construct their very own puppet.', morphemes:[{text:'con',type:'prefix'}, {text:'struct',type:'base'}]},
      {word:'nonstop', sentence:'The talk in the town is nonstop.', morphemes:[{text:'non',type:'prefix'}, {text:'stop',type:'base'}]},
      {word:'attend', sentence:'So many children now attend.', morphemes:[{text:'at',type:'base'}, {text:'tend',type:'base'}]},
      {word:'project', sentence:'They pick objects for each project.', morphemes:[{text:'pro',type:'base'}, {text:'ject',type:'base'}]},
      {word:'insists', sentence:'She insists that the kids be prompt.', morphemes:[{text:'in',type:'base'}, {text:'sists',type:'base'}]},
      {word:'fabric', sentence:'Alex gets scraps of fabric.', morphemes:[{text:'fab',type:'base'}, {text:'ric',type:'base'}]},
      {word:'scraps', sentence:'Alex dashes to get scraps of fabric.'},
      {word:'puppets', sentence:'They will make puppets.', morphemes:[{text:'pup',type:'base'}, {text:'pet',type:'base'}, {text:'s',type:'suffix'}]},
      {word:'baskets', sentence:'There are baskets full of objects.', morphemes:[{text:'bas',type:'base'}, {text:'ket',type:'base'}, {text:'s',type:'suffix'}]},
    ]},
