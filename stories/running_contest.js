...
const ROUNDS_RUNNING_CONTEST = [
  ...
  { id:'spelling', tab:'Spelling', title:"Case File 4 — Spelling Forensics", icon:'✏️',
    ...
    questions:[
      {word:'contest', sentence:'Ted plans to win the next running contest.', morphemes:[{text:'con',type:'base'}, {text:'test',type:'base'}]},
      {word:'invest', sentence:'Ted has been putting in work to invest in his skills.', morphemes:[{text:'in',type:'base'}, {text:'vest',type:'base'}]},
      {word:'signal', sentence:'At the signal, he must dash off.', morphemes:[{text:'sig',type:'base'}, {text:'nal',type:'base'}]},
      {word:'rabbit', sentence:'He must run as quick as a rabbit.', morphemes:[{text:'rab',type:'base'}, {text:'bit',type:'base'}]},
      {word:'fishpond', sentence:'They must bolt down to the fishpond.', morphemes:[{text:'fish',type:'base'}, {text:'pond',type:'base'}]},
      {word:'thrill', sentence:'It is a thrill to get credit for this win.'},
      {word:'credit', sentence:'Ted gets credit for the win.', morphemes:[{text:'cred',type:'base'}, {text:'it',type:'base'}]},
